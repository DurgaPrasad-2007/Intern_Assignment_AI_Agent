...
// Main agent endpoint
app.post('/agent/message', validateMessageRequest, asyncHandler(async (req, res) => {
...
app.get('/agent/sessions/:session_id', validateSessionId, asyncHandler(async (req, res) => {
...
app.delete('/agent/sessions/:session_id', validateSessionId, asyncHandler(async (req, res) => {
    const { session_id } = req.params;
    if (!session_id) {
        res.status(400).json({
            error: 'Session ID is required',
...
app.get('/agent/rag', asyncHandler(async (req, res) => {
